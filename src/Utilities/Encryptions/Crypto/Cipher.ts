...
import { readUInt32BE, writeUInt32BE } from "../../Binaries/Endianess";
import { S, T1, T2, T3, T4, T5, T6, T7, T8 } from "./Constants";
...
export class AES {
    ...
    public encryptBlock(data: Uint8Array, offset: number): void {
